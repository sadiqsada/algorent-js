...
def process_remax_page_fast(url):
	...
	link = "https://maps.googleapis.com/maps/api/staticmap?center=" + address + "&zoom=13&scale=2&size=600x1000&maptype=roadmap&format=png&key=AIzaSyD96V2GIJeJPJqp7wFky7Z6u53dBI_KCR4"
	dark_hex = "0F1210"
