...
const AccountSetting = () => {
        ...
        <Form>
          <ModalContent>
            ...
            <ModalFooter>
              ...
              <Button variant="ghost" onClick={nameOnClose}>
                Cancel
              </Button>
            </ModalFooter>
          </ModalContent>
  ...
  if (avatar) {
    photo = (
      <Center marginBottom="5%">
        <Image boxSize="250px" borderRadius="full" src={img} />
      </Center>
    );
  }
  const photoModal = (
      ...
      <ModalContent>
        ...
        >
          ...
          <ModalFooter>
            ...
            <Button variant="ghost" onClick={photoClose}>
              Cancel
            </Button>
          </ModalFooter>
        </form>
        ...
        <Form>
          <ModalContent>
                  ...
                  >
                    ...
                    <Flex>
                      ...
                      <Button
                        ...
                        disabled={form.errors.email && form.touched.email}
                      >
                        Send Email
                      </Button>
                    </Flex>
              ...
              <Field name="verification">
                {({ field, form }) => (
                  <FormControl
                    ...
                    isRequired
                  >
                    <FormLabel htmlFor="verification">
                      Verification Code
                    </FormLabel>
                    <Input
                      {...field}
            ...
            <ModalFooter>
              ...
              <Button variant="ghost" onClick={emailOnClose}>
                Cancel
              </Button>
            </ModalFooter>
          </ModalContent>
            ...
            <ModalBody>
              ...
              <Field name="comfirmPass" validate={validateConfirmPassword}>
                {({ field, form }) => (
                  <FormControl
                    isInvalid={
                      form.errors.comfirmPass && form.touched.comfirmPass
                    }
                    isRequired
                  >
                    <FormLabel htmlFor="comfrimPass">
                      Confirm Password
                    </FormLabel>
                    <InputGroup>
                      <Input
  ...
  return (
    <>
      <h style={{ fontSize: '30pt', margin: '3%' }}>
        <b>Profile</b>
      </h>
      <Box
      ...
      >
        <Box marginBottom="2%">
          <h style={{ fontSize: '20pt', margin: '3%' }}>
            <b>Personal Info</b>
          </h>
          <Box marginTop="1%">
            <Button
            ...
            <Text float="right" marginRight="2%">
              {currentUser &&
            ...
            <p style={{ fontSize: '10pt', marginLeft: '3%' }}>
              Updates are reflected across all Algorent experiences.
            </p>
            {nameModal}
          </Box>
          <Box marginTop="1%">
